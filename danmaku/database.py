...
#     name="strong enemy",
#     texture_file="strong_enemy.png",
#     texture_size_width=60,
#     texture_size_height=35,
#     speed=20,
#     shoot_v=1000,
#     hp=250,
#     dm=50,
...
#     name="boss",
#     texture_file="strong_enemy.png",
#     texture_size_width=90,
#     texture_size_height=90,
#     speed=10,
#     shoot_v=500,
#     hp=550,
#     dm=70,
...
# basic_bullet = BulletTypes.create(
#     name="basic enemy bullet", texture_file="bullet.png", radius=10, vx=0, vy=1
# )
# basic_bullet.save()

# basic_player_bullet = BulletTypes.create(
#     name="basic player bullet", texture_file="bullet.png", radius=10, vx=0, vy=-1
# )
